  ...
  return (
    <>
      {gameCells.map((cell) => (
        <div
          className={clsx(
            `cell relative inline-block w-[14px] h-[14px] border-[1px] md:w-[20px] md:h-[20px] md:border-2 lg:w-[28px] lg:h-[28px] lg:border-[3px] xl:w-[32px] xl:h-[32px] xl:border-4 bg-gradient-to-br from-gray-50 to-gray-400 border-slate-500 border-t-slate-200 border-l-slate-200 border-solid text-center text-xs md:text-sm lg:text-base xl:text-base text font-bold select-none`,
            {
